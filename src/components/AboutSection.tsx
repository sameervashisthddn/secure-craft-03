        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-6 text-muted-foreground leading-relaxed">
              We partner with organizations to design, implement, and manage secure IT environments. Our team blends deep expertise with a pragmatic approach to deliver measurable outcomes.
            </p>
            <ul className="space-y-3 text-sm text-foreground">
              <li className="flex items-start gap-3"><CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-primary" />10+ years delivering enterprise and SMB solutions</li>
              <li className="flex items-start gap-3"><CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-primary" />Certified across leading vendors and cloud platforms</li>
